...
*42 articles ingested from Miniflux Cyber feeds. Cross-referencing via Reddit skipped — both `/hot/` and `/new/` returned errors (old.reddit.com inaccessible). Prior digests: June 1–5, 2026. Stale CVE/topic blocklist applied: CVE-2026-20245 (Cisco SD-WAN, June 5), Comodo ComoDoS (June 5), Microsoft Edge Pwn2Own (June 5), VerdantBamboo UNC5221 Brickstorm (June 5), triple npm supply chain (June 5), DentaQuest breach (June 5), VECT 2.0 ransomware (June 5), Hola Browser cryptominer (June 5), Malicious AI chatbot extensions (June 5), Gemini voice hijack (June 5), Five Eyes advisory (June 5), MCP servers attack surface (June 5), Cisco Unified CM SSRF (June 4), CVE-2022-0492 container escape (June 4), CVE-2026-3300 Everest Forms (June 4), TA4922 Atlas RAT (June 4), Lazarus npm (June 4), Stock exchange espionage (June 4), VS Code zero-day (June 3), HTTP/2 Bomb (June 3), Microsoft 365 Android debug (June 3), HazyBeacon Lambda C2 (June 3), Mustang Panda PlugX (June 3), AZUREVEIL (June 3), Windows search: URI handler (June 3), CVE-2026-8206 Kirki (June 3), CVE-2026-5386 KMW CCTV (June 3), AI ransomware toolkit (June 3), Trump AI EO (June 3), Project Glasswing expansion (June 3), Android June bulletin (June 2), Oracle WebLogic KEV (June 2), Instagram Meta AI exploit (June 1–2), Dashlane brute-force (June 2), TrapDoor campaign (June 2), Red Hat npm compromise (June 2), PHANTOMPULSE RAT (June 2), Gamaredon (June 2), Screening Serpens (June 2), Chollima Packagist (June 2), Windows Netlogon RCE (June 1), WP Maps Pro (June 1), Kimsuky Binance (June 1), Qilin/Everest ransomwares (June 1), TheGentlemen (June 1), MCP Toolbox CVE-2026-9739 (June 1), LangGraph RCE (June 1), Nightmare Eclipse (June 1–2).*
...
*42 articles ingested from Miniflux Cyber feeds. Cross-referencing via Reddit skipped — old.reddit.com returned errors on both `/hot/` and `/new/` endpoints. Prior digests: June 1–5, 2026. Sources include BleepingComputer, Cyberpress, GBHackers, Malware.News (Cyderes/Howler Cell), SecurityWeek, Microsoft Security Blog, Qualys, Rapid7, Schneier on Security, and ReliaQuest.*

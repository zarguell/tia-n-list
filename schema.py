...
def build_index_entry(cve_record):
    ...
    return {
        ...
        "automatable": cve_record.get("vulnrichment", {}).get("automatable", "unknown"),
        "technical_impact": cve_record.get("vulnrichment", {}).get("technical_impact", "unknown"),
        "exploitation_status": cve_record.get("vulnrichment", {}).get("exploitation_status", "unknown"),
